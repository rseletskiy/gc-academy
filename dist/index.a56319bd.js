...
const heroSlider = new (0, _swiperDefault.default)(".js-hero-slider", {
    effect: "fade",
    duration: 500,
    loop: true,
    ...
    on: {
        init: function(e) {
            ...
            (0, _animeEsDefault.default)({
                ...
                delay: (0, _animeEsDefault.default).stagger(200, {
                    grid: [
                        14,
                        5
                    ],
        ...
        slideChangeTransitionStart: function(e) {
            if (e.activeIndex === 1 || e.activeIndex === 5) heroSlide1Anime();
            if (e.activeIndex === 2) heroSlide2Anime();
            if (e.activeIndex === 3) heroSlide3Anime();
            if (e.activeIndex === 4) heroSlide4Anime();
        }
    }
});
...
const eduSlider = new (0, _swiperDefault.default)(".js-edu-slider", {
    slidesPerView: 3,
    spaceBetween: 30,
    breakpoints: {
        320: {
...
wayBtns.forEach((tab, index)=>{
    tab.addEventListener("click", function(e) {
        e.preventDefault();
        for(let i = 0; i < wayBtns.length; i++)wayBtns[i].classList.remove("active");
...
},{"swiper":"cCbRx","animejs/lib/anime.es":"jokr5","aos":"eRzTM","aos/dist/aos.css":"iYkXi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cCbRx":[function(require,module,exports) {
/**
 * Swiper 8.4.5
...
},{"../../shared/create-shadow.js":"9JYAP","../../shared/effect-init.js":"5DnvG","../../shared/effect-target.js":"eKqS8","../../shared/effect-virtual-transition-end.js":"VhYFx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jokr5":[function(require,module,exports) {
/*
 * anime.js v3.2.1
...
},{}],"iYkXi":[function() {},{}]},["8rGNb","bAabt"], "bAabt", "parcelRequire51d9")
